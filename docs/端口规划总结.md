...
```powershell
# 检查所有服务端口
netstat -ano | findstr "20101 21101 22101 22102 23101 23102 23103"
...
```bash
# 检查所有服务端口
lsof -i :20101 -i :21101 -i :22101 -i :22102 -i :23101 -i :23102 -i :23103
...
**对外开放端口**（需要配置防火墙规则）：
- 20101 - 管理端（仅内网访问）
- 21101 - 后端 API（公网访问，玩家端 WebView 直连）
...
# 允许后端 API（公网，玩家端 WebView 直连）
sudo ufw allow 21101
...
- 例如：80 -> 20101（管理端），443 -> 21101（后端API）
